...
# hostname on which to launch the program
c.SSHControllerLauncher.hostname = 'garnet01.erdc.hpc.mil'
...
c.SSHClusterLauncher.remote_profile_dir = '.ipython/profile_garnet_frontend'
# user@hostname location for ssh in one setting
...
# hostname on which to launch the program
c.SSHProxyEngineSetLauncher.hostname = 'garnet01.erdc.hpc.mil'
